...
import logoImag from '../../../../../public/logo-odonto.png'
    ...
    return (
        <div className='flex min-h-screen w-full'>
            ...
            <aside className={clsx('flex flex-col border-r bg-background transition-all duration-300 p-4 h-full', {
                ...
                <Button
                    className='bg-gray-100 hover:bg-gray-400 text-zinc-900 self-end cursor-pointer mb-2'
                    onClick={() => setIsCollapsed(!isCollapsed)}
                >
                    {
                        !isCollapsed ? <ChevronLeft className='w-12 h-6' /> : <ChevronRight className='w-12 h-6' />
                    }
                </Button>

                {/* mostrar apenas quando a side bar está recolhida */}
                {isCollapsed && (
                ...
                <Collapsible open={!isCollapsed}>
                    ...
                    <CollapsibleContent>
                        <nav className='flex flex-col gap-2 overflow-hidden'>
                            <span className='text-sm text-gry-400 font-medium mt-1 uppercase'>
                                Painel
                            </span>
